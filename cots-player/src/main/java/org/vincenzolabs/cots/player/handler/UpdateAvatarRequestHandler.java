...
/**
 * The {@link RequestHandler} for updating player's avatar.
 *
 * @author Rey Vincent Babilonia
 */
@Component
public class UpdateAvatarRequestHandler implements RequestHandler<Request, Response> {

    private static final Logger LOGGER = LoggerFactory.getLogger(UpdateAvatarRequestHandler.class);
    ...
    public Response handleRequest(Request request, Context context) {
        ...
        try {
            ...
            Player player = playerService.updateAvatar(refreshToken, avatar);
