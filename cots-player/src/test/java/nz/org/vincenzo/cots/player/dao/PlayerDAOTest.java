...
class PlayerDAOTest {
    ...
    @Test
    void retrievePlayerByAccessToken() {
        Player player = putPlayer();
        ...
        Player actual = playerDAO.retrievePlayerByAccessToken(player.getAccessToken());
    ...
    void retrievePlayers() {
        ...
        Set<Player> players = playerDAO.retrievePlayers();
    ...
    private Player putPlayer() {
        return playerDAO.createPlayer("rvincent", "rvbabilonia@gmail.com");
    }
